    ...
    >
      ...
      <div className="mt-4 flex items-end justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-ink-soft">{artist.location}</p>
          <p className="mt-1 text-[11px] uppercase tracking-[0.2em] text-ink-muted">
            {artist.artworksCount} works
          </p>
        </div>
        <span className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-ink transition-colors group-hover:text-terracotta-500">
          View

...
export default function Featured() {
  ...
  return (
    <section id="featured" className="relative overflow-hidden bg-ink py-20 text-white md:py-28">
      ...
      <div className="container-x relative z-10">
        <Reveal className="flex items-end justify-between">
          <div>
            <p className="eyebrow text-white/60">Handpicked</p>
            <h2 className="mt-4 font-display text-5xl font-light leading-tight md:text-6xl">
              <TextReveal text="Featured" />
            </h2>
          </div>
          <p className="hidden max-w-xs text-right text-sm text-white/70 md:block">
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-white/15">
                  ...
                  <div className="absolute inset-x-0 bottom-0 translate-y-3 p-4 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
                    <span className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-[11px] uppercase tracking-[0.18em] text-ink">
                      View Artwork
                ...
                <div className="mt-4">
                  ...
                  <p className="mt-0.5 text-sm text-white/70">{a.artistName} · {a.category}</p>
